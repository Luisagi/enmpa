...
#'
#' @usage
#' jackknife(data, dependent, independent, cv = 3, response_type = "l", weights = NULL)
#'
...
jackknife <- function(data, dependent, independent, cv = 3, response_type = "l",
                      weights = NULL){
  ...
  metrics <- c("ROC_AUC", "TSS", "AIC", "Deviance")
